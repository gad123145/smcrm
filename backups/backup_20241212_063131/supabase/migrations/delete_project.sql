...
-- Replace 'YOUR_PROJECT_ID' with the actual project ID you want to delete
DO $$
DECLARE
    target_project_id UUID := 'YOUR_PROJECT_ID'; -- Replace this with your project ID
BEGIN
...
DO $$
DECLARE
    target_project_id UUID := 'YOUR_PROJECT_ID'; -- Replace with the same project ID
